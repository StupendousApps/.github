...
Workspace-level agent guidance and documentation for the Stupendous codebase.
...
- [`DottyAccountServer`](https://github.com/StupendousApps/DottyAccountServer): Account service for registration and shared user data/content flows.
...
- Root-level workspace guidance lives in [AGENTS.md](AGENTS.md).
- Style examples and coding expectations live under [.agents/style/README.md](.agents/style/README.md).
